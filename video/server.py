...
def detectFakeVideo(videoPath):
    ...
    model.load_state_dict(torch.load(os.path.join(os.getcwd(), 'video', 'model', 'df_model.pt'), map_location=torch.device('cpu')))
    model.eval()
...
def DetectPage():
    ...
    if request.method == 'POST':
        ...
        return render_template('index_video.html', data=data)
